...
var system = function () {
	...
	return {
		...
		send_mail:function(email,message){
			var ajax = this.do_ajax('apparato.net/systems/harmony/Process.php?send-mail',[email,message]);
...
var ini = function () {
	...
	return {
		installDatabase:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-yearlevel',"");
			data.success(function(data){
			});
		},
		checkConnection:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?chkConnection',"");
			data.success(function(data){
				if(data != 1){ 
					// not connected
...
var _process = function () {
	...
	return {		
		autoConnect:function(){
			$("a[data-cmd='dbConnect']").click(function(){
				...
				Materialize.toast('Creating database. Do not interupt.',2000,'',function(){
					var data = system.get_ajax('apparato.net/systems/harmony/Process.php?createDB',"");
					data.success(function(data){
						if(data == 1){
							Materialize.toast('Database created.',5000,'',function(){
								Materialize.toast('Adding tables.',5000,'',function(){
									var data = system.get_ajax('apparato.net/systems/harmony/Process.php?createTables',"");
									data.success(function(data){
										console.log(data);
										if(data != 0){
											system.loader(false);
		...
		checkSchoolDetails:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?checkSchoolDetails',"");
			data.success(function(data){
		...
		logIn:function(){
			$("a[data-cmd='login']").click(function(){
				...
				var data = system.get_ajax('apparato.net/systems/harmony/Process.php?login',data);
				data.success(function(data){
					if(data != 0){
...
var account = function () {
	...
	return {
		ini:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-account',"");
			data.success(function(data){
				data = JSON.parse(data);
		...
		add_student: function(){
			...
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-assoc-yearLevel',"");
			data.success(function(data){
		    ...
		    $("#form_registerStudent").validate({
				...
				submitHandler: function (form) {
					...
					var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-studentInfo',studentInfo);
					data.success(function(data){
						if(data == 1){
		...
		display_studentList:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-students',"");
			data.success(function(data){
		...
		add_yearLevel:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-yearLevel',"");
			data.success(function(data){
				if(data == 1){
					Materialize.toast('Save.',4000);
					App.handleLoadPage(window.location.hash);
		...
		update_schoolInfo:function(){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-schoolInfo',"");
            var months = ["January", "February", "March", "April", "May", "June",  "July", "August", "September", "October", "November", "December"];
			data.success(function(data){
				data = JSON.parse(data);
				console.log(data);
		    ...
		    $("#form_schoolInfo").validate({
				...
				submitHandler: function (form) {
					...
					var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-schoolInfo',form);
					data.success(function(data){
						console.log(data);
						if(data == 1){
							Materialize.toast('Save.',4000);
		...
		sections:function(){
			$("a[data-cmd='add_section']").click(function(){
			    ...
			    $(".formValidate").validate({
					...
					submitHandler: function (form) {
						...
						var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-section',sectionInfo);
						data.success(function(data){
							console.log(data);
							if(data == 1){
								Materialize.toast('Save.',4000);
			...
			$("a[data-cmd='delete-section']").click(function(){
				var data = $(this).data();
				var data = system.get_ajax('apparato.net/systems/harmony/Process.php?delete-section',[data.node]);
				data.success(function(data){
					if(data == 1){
		...
		subject:function(){
			$("a[data-cmd='add_subject']").click(function(){
			    ...
			    $(".formValidate").validate({
					...
					submitHandler: function (form) {
						var form = $(form).serializeArray();
						console.log(form);
						var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-subject',form);
						data.success(function(data){							
							if(data == 1){
								Materialize.toast('Save.',4000);
								system.close_modal();
			...
			$("a[data-cmd='add-sublevelsubject']").click(function(){
			    ...
			    $(".formValidate").validate({
					...
					submitHandler: function (form) {
						...
						var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-sublevelsubject',subjectInfo);
						data.success(function(data){
							console.log(data);
							if(data == 1){
								Materialize.toast('Save.',4000);
			...
			$("a[data-cmd='delete-subject']").click(function(){
				...
				$("a[data-cmd='confirm-delete']").click(function(){
					var data = system.get_ajax('apparato.net/systems/harmony/Process.php?delete-subject',[_data.key,_data.node]);
					data.success(function(data){
						if(data == 1){
							system.close_modal();
							Materialize.toast('Deleted.',4000);
			...
			$("a[data-cmd='delete-sublevelsubject']").click(function(){
				...
				$("a[data-cmd='confirm-delete']").click(function(){
					var data = system.get_ajax('apparato.net/systems/harmony/Process.php?delete-sublevelsubject',[_data.key,_data.node]);
					data.success(function(data){
						if(data == 1){
							system.close_modal();
							Materialize.toast('Deleted.',4000);
			    ...
			    $(".form_gradesheet").validate({
					...
					submitHandler: function (form) {
						if($("input[name='field_highGrade']").val() == ""){
							...
							var data = system.get_ajax('apparato.net/systems/harmony/Process.php?set-grade',form);
							data.success(function(data){							
								if(data == 1){
		...
		get_grade:function(controls){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-grade',controls);
			data.success(function(data){		
				// console.log(data);				
		...
		get_gradeSummary:function(controls){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-gradeSummary',controls);
			data.success(function(data){		
				console.log(data);				
				// localStorage.setItem("grades_gradeSheetQuarter",data);
			});
		...
		get_student:function(controls){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-studentsGradeSheet',controls);
			data.success(function(data){
				// console.log(data);
				data = JSON.parse(data);
		...
		get_subjectDetails:function(controls){
			var data = system.get_ajax('apparato.net/systems/harmony/Process.php?get-subjectDetails',controls);
			data.success(function(data){
				data = JSON.parse(data);
